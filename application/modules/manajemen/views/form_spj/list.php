  ...
  <div class="row" id="formParent">
    <div class="col-xs-12 col-sm-12">
      <div class="btn-toolbar" style="margin-bottom: 15px">
       <!--  <a type="button" href="<?php echo site_url('manajemen/spj'); ?>" class="btn btn-inverse" name="button" style="padding:12px 16px;"><b><i class="fa fa-table"></i> Data User</b></a>
...
<div class="modal fade in" id="modalEntryForm" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" id="frmEntry">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url('manajemen/spj/create'), array('id' => 'formEntry')); ?>
      <div class="modal-body" style="padding:15px 15px 5px 15px;">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4">
            <div class="form-group required">
              ...
              <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Nama Lengkap" value="<?php echo $this->input->post('fullname', TRUE); ?>" readonly>
          ...
          <div class="col-xs-12 col-sm-4">
            <div class="form-group required">
              ...
              <input type="text" class="form-control" name="username" id="username" placeholder="Username" value="<?php echo $this->input->post('username', TRUE); ?>" readonly>
              <div class="help-block"></div>
            </div>
          </div>
        </div>
        ...
        <div class="row">          
          <div class="col-xs-12 col-sm-4">
            <div class="form-group required">
              <label for="nm_opd" class="control-label" style="font-size:15px;"><b>Nama OPD <font color="red">*</font></b></label>
              <input type="text" class="form-control" name="nm_opd" id="nm_opd" placeholder="Nama OPD" value="<?php echo $this->input->post('nm_opd', TRUE); ?>" readonly>
              <div class="help-block"></div>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-4">
            <div class="form-group required">
              <label for="nm_sub_opd" class="control-label" style="font-size:15px;"><b>Nama Sub OPD <font color="red">*</font></b></label>
              <input type="text" class="form-control" name="nm_sub_opd" id="nm_sub_opd" placeholder="Nama Sub OPD" value="<?php echo $this->input->post('nm_sub_opd', TRUE); ?>" readonly>
              <div class="help-block"></div>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  function getDataListUser() {
    $('#listuser').dataTable({
      ...
      "ordering": false,
      "ajax": {
        "url": site + "manajemen/spj/listview",
        "type": "POST",
        "data": {
  ...
  function formReset() {
    $('#formEntry').attr('action', site + 'manajemen/spj/create');
    $('#errEntry').html('');
  ...
  $(document).on('click', '.btnEdit', function(e){
    ...
    $('#formEntry').attr('action', site + 'manajemen/spj/update');
    $('.lblPass').text('');
    $('#modalEntryForm').modal({
      backdrop: 'static'
    });
  ...
  function getDataUser(token) {
    ...
    $.ajax({
      type: 'POST',
      url: site + 'manajemen/spj/details',
      ...
      success: function(data) {
        ...
        if(data.status == 1) {
          ...
          $('#nm_opd').val(data.message.nm_opd);
          $('#nm_sub_opd').val(data.message.nm_sub_opd);
  ...
  function checkUsername(newname) {
		$.ajax({
      type: 'POST',
      url: site + 'manajemen/spj/searching',
