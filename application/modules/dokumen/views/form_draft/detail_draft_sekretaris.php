    ...
    <div class="col-md-12">
      ...
      <div class="row">
          <div class="col-md-12">
                     ...
                     <tr>
                      ...
                      <td><?php
                        ...
                        if ( ($dokumen !="") && file_exists('images/agenda/'.$tahun.'/'.$bulan.'/'.$dokumen) ){
                         ...
                         $f=realpath('images/agenda/'.$tahun.'/'.$bulan.'/'.$dokumen);
            ...
            <div class="col-md-6">
                <div class="panel panel-primary" <?php echo $showDoc;?>>
                    <div class="panel-heading">
                      <h4>Dokumen</h4>
                    </div>
      ...
      <?php 
      if ($this->app_loader->is_admin() ||  $this->app_loader->is_sekretaris()) 
      {
              ...
              <div class="col-md-12">
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                       <?php echo form_open(site_url('dokumen/draft/acc'), array('class' => 'form-horizontal row-border', 'role' => 'form')); ?>
                        <div class="panel-body">
                        <input type="hidden" name="token" value="<?php echo $detail['token'];?>" >
                          ...
                          <div class="form-group" id="disposisi" >
                            ...
                            <div class="col-sm-6">
                              <select name="penerima_disposisi[]" id="penerima_disposisi" class="select-all" style="width:100%" data-placeholder="Pilih Data" multiple="multiple">
