      ...
      <div class="panel panel-green">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control tooltips" name="keterangan" id="keterangan" placeholder="keterangan"  value="<?php echo $detail['ket'];?>" data-trigger="hover" data-original-title="keterangan yang akan digunakan">
              ...
              <span class="help-block"><i>* File Yang Telah Diupload : </i>
               <?php
                ...
                echo '<a href="'.site_url('master/tentang/download/'.$detail['token'].'/'.create_url($detail['judul'])).'" 
                      class=""><i class="fa fa-download"></i> '.$detail['gambar'].'</a>';
                //echo '<img src="'.realpath('./images/tentang/'.$year.'/'.$month.'/'.$detail['gambar']).'" />';
                }
                else{
