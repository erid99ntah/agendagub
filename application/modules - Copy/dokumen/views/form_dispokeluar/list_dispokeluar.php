      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body collapse in">
          <div class="table-responsive">
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="tblDispokeluar" width="100%">
              <thead>
                <tr>
                  <th width="3%">#</th>
...
<div class="modal fade in" id="modalEntryForm" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" id="frmEntry">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(site_url('dokumen/disposisi/create'), array('id' => 'formEntry')); ?>
...
<div class="modal fade in" id="modalEntryFormReview" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" id="frmEntryReview">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(site_url('dokumen/disposisi/approve'), array('id' => 'formEntryReview')); ?>
      <div class="modal-body" style="padding:15px 15px 5px 15px;">
...
<script type="text/javascript">
  ...
  function getDataListDisposisiKeluar() {
    $('#tblDispokeluar').dataTable({
      "destroy": true,
      "processing":true,
      "language": {
      ...
      "ordering": false,
      "ajax": {
        "url": site + "dokumen/dispokeluar/listview",
        "type": "POST",
        "data": {
    ...
    $('#tblDispokeluar_filter input').addClass('form-control').attr('placeholder','Search Data');
    $('#tblDispokeluar_length select').addClass('form-control');
  }
  ...
  function formReset() {
    $('#formEntry').attr('action', site + 'dokumen/disposisi/create');
    $('#errEntry').html('');
    $('.select-all').select2('val', '');
  ...
  $(document).on('click', '.btnEdit', function(e){
    formReset();
    $('#formEntry').attr('action', site + 'dokumen/disposisi/update');
  ...
  function getDetailAgenda(token) {
    ...
    $.ajax({
      type: 'POST',
      url: site + 'dokumen/disposisi/details',
      ...
      buttons: {
        ...
        "main" : {
          ...
          callback:function(response){
            if (response) {
              $.ajax({
                url: site + 'dokumen/disposisi/delete',
                type: "POST",
                data: postData,
                dataType: "json",
              }).done(function(data) {
  ...
  $(document).on('click', '.btnReview', function(e){
    formResetReview();
    $('#formEntryReview').attr('action', site + 'dokumen/disposisi/approve');
    var token = $(this).data('id');
  ...
  $(document).on('click', '.btnReject', function(e){
    formReset();
    $('#formEntryReview').attr('action', site + 'dokumen/disposisi/reject');
    var token = $(this).data('id');
    var nama_agenda = $(this).data('nm');
