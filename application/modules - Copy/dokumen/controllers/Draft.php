...
class Draft extends SLP_Controller {
	...
	public function review()
	{
		...
		if ($detail_agenda['jenis_agenda']=='P'){
			$this->template->build('form_draft/detail_draft_pimpinan', $this->session_info);
		}
		else{
			$this->template->build('form_draft/detail_draft_sekretaris', $this->session_info);	
		}
	}
