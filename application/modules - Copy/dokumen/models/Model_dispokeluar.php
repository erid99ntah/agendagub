...
class Model_dispokeluar extends CI_Model
{
	...
	public function validasiDataValue()
	{
	  ...
	  var $search = array('a.tgl_disposisi', 'a.isi_disposisi', 'b.nama_agenda');
	...
	public function count_filtered($param)
	  ...
	  {
	    return $this->db->count_all_results('data_disposisi');
	  }
	  ...
	  {	  		
			...
			$this->db->select('a.token,a.id_disposisi, a.token, a.id_agenda, a.isi_disposisi, a.tgl_disposisi, a.id_pengirim,
							   b.nama_agenda, b.tanggal');
	...
	public function getIDPenerimaDisposisi($id_disposisi)
	{
		$this->db->select('a.id_penerima, b.fullname as nama');
	...
	public function getDetailDisposisi($token){
		$this->db->select('a.*, b.fullname');
		$this->db->from('data_disposisi a');
