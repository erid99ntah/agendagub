...
function get_word($phpWord, $filename, $writer) {
    // Save File
    $temp_file_uri = tempnam(APPPATH . '/tmp', $filename);
    $phpWord= IOFactory::createWriter($phpWord, $writer);
    $phpWord->save($temp_file_uri);

    $filename=  str_replace('_docx', '', $filename);
// Download the file:
